   ...
   useEffect( () => {
      ...
      fetch(`${api}/classes/${classId}/${examId?examId+"/":""}dashboard`, {
         ...
         .then((grades) => {
            ...
            setTotal(grades.data.grade_0 + grades.data.grade_1 + grades.data.grade_2 + grades.data.grade_3 + grades.data.grade_4 + grades.data.grade_5 + grades.data.grade_6 + grades.data.grade_7 + grades.data.grade_8 + grades.data.grade_9 + grades.data.grade_10)
         });
   },[])
   return (
      <>
