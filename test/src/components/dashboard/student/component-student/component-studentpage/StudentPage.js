						...
						(item, number) =>
							(
								<ExamItem
									...
									time={item.duration}
									timeStart={vietNamFomatter.format(new Date(item.timeStart))}
									timeEnd={vietNamFomatter.format(new Date(item.timeEnd))}
					...
					(item) =>
						(
							<div className="flex-center mobile-table-item">
								...
								<span>{vietNamFomatter.format(new Date(item.timeStart))}</span>
								<span>{vietNamFomatter.format(new Date(item.timeEnd))}</span>
