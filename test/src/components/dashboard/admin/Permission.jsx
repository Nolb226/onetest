		...
		<>
			...
			<div className="gridContainer">
				...
				<ul className="right-item">
						...
						<ul className="permission-list">
							...
							<li className="permission-item">
								<input
									...
									disabled={isDisabled}
									checked={
										functions.filter((func) => func.id == 28).length == 0
											? false
											: true
									}
								/>
					...
					<li className="permission-table">
						<h2 className="permission-table__heading">Phân công</h2>
						...
						<ul className="permission-list">
							<li className="permission-item">
								<input
									...
									disabled={isDisabled}
									checked={
										functions.filter((func) => func.id == 25).length == 0
											? false
											: true
									}
								/>
							...
							<li className="permission-item">
								<input
									...
									disabled={isDisabled}
									checked={
										functions.filter((func) => func.id == 26).length == 0
											? false
											: true
									}
								/>
							...
							<li className="permission-item">
								<input
									...
									disabled={isDisabled}
									checked={
										functions.filter((func) => func.id == 27).length == 0
											? false
											: true
									}
								/>
