      ...
      <div className="wide container__wrap">
        <div className="container__content">
          <span className="container__content--subheading">
            Chào mừng bạn đến với website thi trắc nghiệm tốt nhất hiện nay. Hi
            vọng chúng tôi sẽ mang lại trải nghiệm tuyệt với trong học tập.
          </span>
              ...
              <div className="feature flex-direction-col">
                ...
                <div className="feature__content">
                  ...
                  <span className="feature__content--description">
                    Thiết kế tối giản, gam màu tươi mới, phù hợp với mọi đối
                    tượng sử dụng, tối ưu hóa sự tập trung, hạn chế xao nhãng.
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="col m-4">
              <div className="feature flex-direction-col">
                ...
                <div className="feature__content">
                  ...
                  <span className="feature__content--description">
                    Nhóm học, bài thi cấu trúc phân loại. Thống kê và chấm điểm
                    tự động qua Excel. Dễ dàng quản lí, theo dõi tình hình lớp.
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="col m-4">
              <div className="feature flex-direction-col">
                ...
                <div className="feature__content">
                  ...
                  <span className="feature__content--description">
                    Sau khi làm xong bài kiểm tra, hệ thống sẽ thông báo số điểm
                    đạt được, kèm đáp án. Dễ dàng cải thiện cho lần sau.
                  </span>
                </div>
              </div>
            </div>
